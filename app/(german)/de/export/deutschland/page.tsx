...
export const metadata: Metadata = {
  ...
  description: "Indischer Hersteller und Exporteur von Henna, Indigo, pflanzlichen Haarfarben, ayurvedischen Kräutern und Gewürzen für deutsche B2B-Einkäufer. Großbestellungen können ab 100 kg je Artikel beginnen, vorbehaltlich der Bestätigung des Produkts und der Handelsbedingungen. Die Mindestbestellmenge für Private Label hängt von Packungsgröße, Verpackungsdesign, Individualisierung und Bestellanforderungen ab.",
  keywords,
...
const supplyServices = [
  { title: "Großgebinde und Großhandel", text: "Handelsmengen für deutsche Importeure und Großhändler können in geeigneten Groß-, Profi- oder ausgewählten Einzelhandelsformaten vorbereitet werden. Großbestellungen können ab 100 kg je Artikel beginnen, vorbehaltlich der Bestätigung des Produkts und der Handelsbedingungen. Die Mindestbestellmenge für Private Label hängt von Packungsgröße, Verpackungsdesign, Individualisierung und Bestellanforderungen ab." },
...
const faqs = [
  ...
  { question: "Welche MOQ gilt für Großhandelsbestellungen nach Deutschland?", answer: "Großbestellungen können ab 100 kg je Artikel beginnen, vorbehaltlich der Bestätigung des Produkts und der Handelsbedingungen. Die Mindestbestellmenge für Private Label hängt von Packungsgröße, Verpackungsdesign, Individualisierung und Bestellanforderungen ab. Die praktikable Menge und Verpackungskonfiguration können zusätzlich vom gewählten Produkt und dem Eigenmarkenbriefing abhängen." },
...
const structuredData = {
  ...
  "@graph": [
    ...
    { "@type": "Service", "@id": `${pageUrl}#service`, name: "Exportlieferung von Naturprodukten nach Deutschland", serviceType: "Naturprodukte in Großmengen, für den Großhandel, als OEM und Private Label", description: "Exportorientierte Lieferung indischer Naturprodukte für Importeure, Distributoren, Großhändler, Salonlieferanten und Marken in Deutschland.", url: pageUrl, provider: { "@id": "https://shiveshinternational.com/#organization" }, areaServed: { "@type": "Country", name: "Deutschland", sameAs: "https://www.wikidata.org/wiki/Q183" }, audience: { "@type": "BusinessAudience", audienceType: buyerTypes.join(", ") }, category: products.map((product) => product.title), termsOfService: "Großbestellungen können ab 100 kg je Artikel beginnen, vorbehaltlich der Bestätigung des Produkts und der Handelsbedingungen. Die Mindestbestellmenge für Private Label hängt von Packungsgröße, Verpackungsdesign, Individualisierung und Bestellanforderungen ab. Produkt, Verpackung, Dokumentation und Handelsbedingungen werden für jede Käuferanforderung bestätigt." },

...
const processSteps = [
  ...
  ["Spezifikation und Menge bestätigen", "Prüfen Sie die angefragte Qualität, verfügbare Spezifikation und die Mindestmenge für Großbestellungen ab 100 kg je Artikel, vorbehaltlich der Bestätigung des Produkts und der Handelsbedingungen."],
...
const faqs = [
  ...
  { question: "Welche Mindestbestellmenge gilt für österreichische Einkäufer?", answer: "Großbestellungen können ab 100 kg je Artikel beginnen, vorbehaltlich der Bestätigung des Produkts und der Handelsbedingungen. Die Mindestbestellmenge für Private Label hängt von Packungsgröße, Verpackungsdesign, Individualisierung und Bestellanforderungen ab. Die endgültigen Mengen hängen vom ausgewählten Produkt, Verpackungsformat und den Eigenmarkenanforderungen ab." },

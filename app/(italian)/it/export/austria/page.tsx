...
const keywords = [
  ...
  "confezionamento a marchio proprio Austria", "coordinamento etichette in tedesco Austria", "documentazione export India Austria", "spedizione prodotti naturali India Austria", "MOQ per ordini sfusi da 100 kg prodotti naturali Austria", "Shivesh International Austria",
];
...
const processSteps = [
  ...
  ["Confermate specifiche e quantità", "Verificate qualità richiesta, specifiche disponibili e quantità minima per ordini sfusi a partire da 100 kg per articolo, previa conferma del prodotto e delle condizioni commerciali."],
...
const faqs = [
  ...
  { question: "Qual è la quantità minima d’ordine per gli acquirenti austriaci?", answer: "Gli ordini sfusi possono partire da 100 kg per articolo, previa conferma del prodotto e delle condizioni commerciali. Il MOQ Private Label dipende dal formato della confezione, dal design del packaging, dalla personalizzazione e dai requisiti dell’ordine. Le quantità finali dipendono dal prodotto, dal confezionamento e dai requisiti Private Label." },

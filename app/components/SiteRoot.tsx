...
export default function SiteRoot({ children, lang, structuredData = defaultStructuredData }: Readonly<{ children: React.ReactNode; lang: "en" | "de"; structuredData?: object }>) {
  return (

                ...
                : selectedCode === "FR"
                  ...
                  : selectedCode === "ES"
                    ...
                    : pathname === "/es/export/alemania"
                      ...
                      : "El español y el inglés están disponibles para esta página."
                  : selectedCode === "IT"
                    ? pathname === "/it/export/polonia"
                      ? "Italiano e inglese sono disponibili per questa pagina."
                      : pathname === "/it/export/paesi-bassi"
                      ? "Italiano e inglese sono disponibili per questa pagina."
                      : pathname === "/it/export/austria"
                      ? "Italiano, inglese e tedesco sono disponibili per questa pagina."
                  ...
                  : pathname === "/export/argentina"
                    ? "English and Spanish are available for the Argentina page."
                  : pathname === "/export/usa"
                    ? "English and Spanish are available for the USA page."
                  ...
                  : pathname === "/export/finland"
                    ? "English and Italian are available for the Finland page."
                  : pathname === "/export/netherlands"
                    ? "English and Italian are available for the Netherlands page."
                  : pathname === "/export/austria"
                    ? "German and Italian are available for the Austria page."

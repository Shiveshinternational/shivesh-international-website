...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Indian natural products exporter UK",
    "natural products manufacturer India for UK",
    "natural products wholesale supplier UK",
    "bulk natural products supplier UK",
    "private label natural products UK",
    "OEM natural products manufacturer for UK",
    "Indian botanical products supplier UK",
    "herbal products exporter to UK",

    "henna powder exporter to UK",
    "natural henna powder supplier UK",
    "natural henna powder manufacturer for UK",
    "Indian henna powder exporter UK",
    "Sojat henna powder supplier UK",
    "bulk henna powder supplier UK",
    "wholesale henna powder exporter UK",
    "organic henna powder supplier UK",
    "private label henna powder UK",
    "OEM henna powder manufacturer UK",
    "henna powder importer supplier UK",
    "henna powder distributor supply UK",
    "export grade henna powder UK",

    "indigo powder exporter to UK",
    "natural indigo powder supplier UK",
    "natural indigo powder manufacturer for UK",
    "Indian indigo powder exporter UK",
    "bulk indigo powder supplier UK",
    "wholesale indigo powder exporter UK",
    "organic indigo powder supplier UK",
    "private label indigo powder UK",
    "OEM indigo powder manufacturer UK",
    "Indigofera tinctoria powder supplier UK",
    "botanical hair colour powder supplier UK",

    "natural henna hair colours exporter UK",
    "botanical hair colours supplier UK",
    "natural hair colour manufacturer for UK",
    "henna hair colour wholesale supplier UK",
    "private label henna hair colours UK",
    "OEM botanical hair colours UK",
    "professional salon hair colours supplier UK",
    "natural hair dye exporter to UK",
    "powder hair colour supplier UK",

    "Ayurvedic herbs exporter to UK",
    "Ayurvedic herbs supplier UK",
    "Indian herbal powders exporter UK",
    "bulk herbal powder supplier UK",
    "wholesale Ayurvedic herbs UK",
    "private label Ayurvedic herbs UK",
    "botanical powders wholesaler UK",
    "Indian herbs supplier for UK brands",

    "Indian spices exporter to UK",
    "Indian spices supplier UK",
    "bulk Indian spices exporter UK",
    "wholesale spices supplier UK",
    "private label Indian spices UK",
    "whole and ground spices exporter UK",
    "Indian spice manufacturer for UK buyers",

    "UK importer natural products India",
    "UK distributor natural products India",
    "UK wholesale botanical products supplier",
    "natural products supplier for British brands",
    "private label supplier for UK brands",
    "Indian exporter for UK cosmetic brands",
    "Indian exporter for UK salon brands",
    "Indian exporter for UK wellness brands",
    "retail packaging natural products UK",
    "bulk packaging natural products UK",
    "customised packaging natural products UK",
    "export documentation support for UK",
    "natural products shipping from India to UK",
    "Shivesh International UK exporter",
  ],
  alternates: {
    canonical: pageUrl,
  },

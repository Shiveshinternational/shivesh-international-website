...
const certificationHighlights = [
  ...
  "Buyer-Oriented Compliance Support",
];
...
export default function CertificationSection() {
  return (
    <section
      id="certifications"
      className="relative overflow-hidden bg-[#0E3A2A] px-5 py-20 text-[#F5F0E6] sm:px-8 sm:py-24 lg:px-12 lg:py-28"
    >
      {/* Background atmosphere */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-44 top-16 h-[420px] w-[420px] rounded-full bg-[#C9A962]/[0.06] blur-[140px]"
      />

      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-52 bottom-0 h-[500px] w-[500px] rounded-full bg-[#C9A962]/[0.045] blur-[150px]"
      />

      <RevealOnScroll>
        <div className="relative mx-auto grid max-w-[1500px] items-center gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20">
          {/* =================================================
              LEFT CONTENT
          ================================================= */}
          <div className="relative">
            ...
            <StaggerItem delay={240}>
              <p className="mt-6 max-w-[620px] font-[family-name:var(--font-playfair)] text-xl italic leading-relaxed text-[#E4C878] sm:text-2xl">
                Structured quality systems that support consistency,
            ...
            <StaggerItem delay={360}>
              <p className="mt-7 max-w-[650px] text-[16px] font-light leading-[1.9] text-[#F5F0E6]/62 sm:text-[17px]">
                Our certifications and quality systems reflect a professional
                approach to manufacturing, processing and export supply. We
                support international buyers with controlled procedures,
                product-specific documentation and compliance-oriented
            ...
            <div className="mt-9 grid gap-3 sm:grid-cols-2">
              {certificationHighlights.map((item, index) => (
                <StaggerItem key={item} delay={480 + index * 85}>
            ...
            <StaggerItem delay={940}>
              <div className="mt-8 flex items-center gap-4">
                ...
                <span className="text-[9px] font-semibold uppercase tracking-[0.28em] text-[#F5F0E6]/38">
                  Quality · Documentation · Compliance · Confidence
                </span>
              </div>
            </StaggerItem>
          </div>
          ...
          <StaggerItem delay={260}>
            <div className="relative">
              ...
              <div className="group relative min-h-[560px] overflow-hidden rounded-[26px] border border-[#C9A962]/28 bg-[#173B2A] shadow-[0_28px_70px_rgba(0,0,0,0.22)] lg:min-h-[620px]">
                <Image
                  src="/images/products/certifications/certifications-premium-office-v2.png"
                  alt="Shivesh International certifications and compliance overview"
                  fill
                  sizes="(min-width: 1024px) 55vw, 100vw"
                  className="object-cover object-center transition-transform duration-[1200ms] ease-out group-hover:scale-[1.035]"
                />

                <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-[#071B14]/62 via-transparent to-black/5" />
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8">
                  <div className="max-w-[500px] border border-white/15 bg-[#0D2F22]/74 p-5 backdrop-blur-md">
                    ...
                    <p className="mt-3 font-[family-name:var(--font-playfair)] text-[24px] font-medium leading-[1.25] text-[#F7F1E7] sm:text-[28px]">
                      Professional Systems for Reliable Global Supply
                    </p>
                  </div>
                </div>
              </div>
